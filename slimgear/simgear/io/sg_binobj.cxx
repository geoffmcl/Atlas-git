...
//
// $Id: sg_binobj.cxx,v 1.2 2017/03/14 03:49:04 schack Exp $
//
                         ...
                         string_list& materials)
{
    ...
    for ( j = 0; j < nelements; ++j ) {
        ...
        int_list ns;
        int_list cs;
	// EYE - need to change since we aren't using Boost (see sg_binobj.hxx)
        // tci_list tcs;
        // vai_list vas;
        tci_list tcs(MAX_TC_SETS);
        vai_list vas(MAX_VAS);
